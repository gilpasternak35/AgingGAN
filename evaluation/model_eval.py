...
def eval_model(model_path: str = "../models/conditional_gan_gen_epoch199expconditional_baseline", eval_data_path: str="../eval_data", save_dir: str = "../eval_results", display:bool=True, size:int = 1) -> None:
    """
